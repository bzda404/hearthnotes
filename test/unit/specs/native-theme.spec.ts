...
describe('Native theme source', () => {
  ...
  it('uses dark native menus for dark AinCore Notes themes', () => {
  ...
  it('uses the shared AinCore Notes dark theme classification', () => {
  ...
  it('uses light native menus for light AinCore Notes themes', () => {

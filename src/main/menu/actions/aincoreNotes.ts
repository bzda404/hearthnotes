...
autoUpdater.on('update-downloaded', (_event) => {
  // Notify the renderer that an update is available and ready to install.
  // The renderer prompts the user to save work before applying the update.
  if (win) {
    win.webContents.send(
...
export const loadAinCoreNotesCommands = (commandManager: CommandManager): void => {

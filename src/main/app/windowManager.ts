...
class WindowManager extends TypedEmitter<WindowManagerEvents> {
  ...
  constructor(
    ...
    // Watcher is instantiated here with preferences access for lifecycle management.
    // Each editor window's watch paths are registered via Watcher.watch() / .unwatch().
